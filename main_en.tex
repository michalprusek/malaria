...
low that it flags nearly every cell. The simple baseline therefore fails to meet the clinical
bar; this is exactly why a learned model is needed (your task).
