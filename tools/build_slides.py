  ...
  <section class="slide">
    <div class="wrap">
      ...
      <div class="chips reveal" style="--i:3">
        ...
        <span class="chip">ÚTIA AV ČR</span>
        <span class="chip">PhD · FJFI ČVUT</span>
        <span class="chip">biomedicínská segmentace</span>
      </div>
    </div>
  </section>
  ...
  <section class="slide">
    <div class="wrap grid2">
      <div>
        ...
        <h2 class="reveal" style="--i:1">Michal Průšek</h2>
        <ul class="list">
          <li class="reveal" style="--i:2"><span><strong>PhD student</strong> na FJFI ČVUT (Fakulta jaderná a fyzikálně inženýrská).</span></li>
          <li class="reveal" style="--i:3"><span>Výzkumník na <strong>ÚTIA AV ČR</strong> — Ústavu teorie informace a automatizace Akademie věd.</span></li>
          <li class="reveal" style="--i:4"><span>Věnuji se <strong>biomedicínské segmentaci</strong> obrazu — učím počítače rozpoznávat buňky, organoidy a struktury v mikroskopických snímcích.</span></li>
          <li class="reveal" style="--i:5"><span>Dnes si na malárii ukážeme, jak se z téhle vědy stane <span class="teal">funkční nástroj</span>.</span></li>
        </ul>
      </div>
      <div class="reveal" style="--i:3">
        <div class="card">
          <h3>Co dnes zvládneme</h3>
          <ul class="list" style="margin-top:.6rem">
            <li>Pochopíme problém i data</li>
            <li>Rozebereme síť <span class="tt">ResNet</span></li>
            <li>Postavíme baseline <span class="tt">k-NN</span></li>
            <li>Uvidíme, jak featury <span class="teal">samy</span> oddělují třídy</li>
            <li>Překonáme baseline <span class="tt">MLP</span></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="grid2" style="margin-top:.6rem">
        ...
        <div class="reveal" style="--i:4">
          <div class="card">
            ...
            <p style="font-size:1rem">Michal Průšek · ÚTIA AV ČR · FJFI ČVUT</p>
