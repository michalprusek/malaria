...
<div class="deck" id="deck">
  ...
  <!-- ÚKOL / PRAVIDLA SOUTĚŽE -->
  <section class="slide">
    <div class="wrap">
      <div class="kicker reveal" style="--i:0">Veletrh vědy · soutěž</div>
      <h2 class="reveal" style="--i:1">Váš úkol</h2>
      <div class="grid2" style="margin-top:.5rem">
        <div>
          <h3 class="reveal" style="--i:2">Pravidla</h3>
          <ul class="list" style="margin-top:.5rem">
            <li class="reveal" style="--i:3"><span>Použijte <strong>zmrazený ResNet encoder</strong> — featury jsou dané. <strong>Trénujte jen klasifikátor</strong> (hlavu); encoder se neučí.</span></li>
            <li class="reveal" style="--i:4"><span>Stejná data pro oba týmy; odevzdáte <strong>pravděpodobnosti</strong> na skrytém testu.</span></li>
            <li class="reveal" style="--i:5"><span><strong>ChatGPT povolen</strong> — ale svou metodu musíte umět <strong>srozumitelně odprezentovat</strong> všem, aby jí rozuměli.</span></li>
          </ul>
        </div>
        <div class="reveal" style="--i:3">
          <div class="card" style="border-color:rgba(53,214,192,.5);box-shadow:0 0 40px rgba(53,214,192,.08)">
            <h3>Vyhodnocení</h3>
            <p>Senzitivitu <strong>zafixujeme na 99 %</strong> — musíte zachytit aspoň 99 % nemocných.</p>
            <p style="margin-top:.5rem">Boduje se <span class="teal"><strong>specificita</strong></span> při této senzitivitě: kdo přitom <strong>nejméně</strong> zbytečně poplaší zdravé.</p>
            <p style="margin-top:.7rem;font-size:1.1rem"><strong>🏆 Vyšší specificita vyhrává.</strong></p>
          </div>
        </div>
      </div>
    </div>
